!(function(e, t) {
                              ...
                              if (c) {
                                  ...
                                  if (((u = [m ? c.firstChild : c.lastChild]), m && p)) {
                                      for (
                                          d =
                                              (s =
                                                  (r = (i = (o = (a = c)[k] || (a[k] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === S &&
                                                  r[1]) && r[2],
                                              a = s && c.childNodes[s];
                                      ...
                                      (p &&
                                          (d = s =
                                              (r = (i = (o = (a = e)[k] || (a[k] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === S &&
                                              r[1]),
                                      !1 === d)
                                  )
                                      for (
        ...
        (Y.prototype = {
            cache: function(e) {
                ...
                return (
                    t ||
                        ((t = {}),
                        G(e) && (e.nodeType ? (e[this.expando] = t) : Object.defineProperty(e, this.expando, {value: t, configurable: !0}))),
                    t
                );
            },
            set: function(e, t, n) {
            ...
            k.event.special[e] = {
                ...
                handle: function(e) {
                    var t,
                        ...
                        r = e.handleObj;
                    return (
                        (n && (n === this || k.contains(this, n))) || ((e.type = r.origType), (t = r.handler.apply(this, arguments)), (e.type = i)), t
                    );
                },
            };
        }),
            ...
            k.cssHooks[u] = {
                ...
                set: function(e, t, n) {
                    ...
                    return (
                        a &&
                            o &&
                            (s -= Math.ceil(e['offset' + u[0].toUpperCase() + u.slice(1)] - parseFloat(i[u]) - et(e, u, 'border', !1, i) - 0.5)),
    ...
    function dt(o, e, t) {
        var n,
            ...
            u = function() {
                if (a) return !1;
                for (
                    var e = rt || ct(), t = Math.max(0, l.startTime + l.duration - e), n = 1 - (t / l.duration || 0), r = 0, i = l.tweens.length;
                    r < i;
                    r++
                )
                    l.tweens[r].run(n);
        ...
        k.fn.extend({
            ...
            toggleClass: function(i, t) {
                ...
                return 'boolean' == typeof t && a
                    ...
                    : this.each(function() {
                          var e, t, n, r;
                          if (a) for (t = 0, n = k(this), r = bt(i); (e = r[t++]); ) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
                          else
                              (void 0 !== i && 'boolean' != o) ||
    ...
    (function() {
        ...
        'undefined' == typeof exports || exports.nodeType
            ? (n._ = h)
            : ('undefined' != typeof module && !module.nodeType && module.exports && (exports = module.exports = h), (exports._ = h)),
            (h.VERSION = '1.9.1');
        function y(u, i, n) {
        ...
        (h.pick = g(function(n, r) {
            ...
            h.each(['Arguments', 'Function', 'String', 'Number', 'Date', 'RegExp', 'Error', 'Symbol', 'Map', 'WeakMap', 'Set', 'WeakSet'], function(
                r
            ) {
                h['is' + r] = function(n) {
    ...
    (function(t) {
        ...
        (a.off = function(t, e, i) {
            return this._events && (this._events = u(f, this._events, t, e, {context: i, listeners: this._listeners})), this;
        }),
        ...
        i.extend(m.prototype, a, {
            ...
            set: function(t, e, n) {
                ...
                for (var f in r)
                    (e = r[f]), i.isEqual(u[f], e) || o.push(f), i.isEqual(c[f], e) ? delete l[f] : (l[f] = e), s ? delete u[f] : (u[f] = e);
                ...
                if (null != t) {
                    ...
                    if (
                        (s.length && E
                            ...
                            : a.length && (v && (d = !0), x(this.models, a, null == r ? this.length : r), (this.length = this.models.length)),
                        d && this.sort({silent: !0}),
                        !e.silent)
                    ) {
                        for (m = 0; m < a.length; m++) null != r && (e.index = r + m), (g = a[m]).trigger('add', g, this, e);
                        (d || w) && this.trigger('sort', this, e),
                            (a.length || h.length || o.length) && ((e.changes = {added: a, removed: h, merged: o}), this.trigger('update', this, e));
                    }
                    return n ? t[0] : t;
                }
            },
        ...
        i.each(
            ...
            (e.sync = function(t, n, r) {
                ...
                if (
                    ...
                    r.emulateJSON && ((a.contentType = 'application/x-www-form-urlencoded'), (a.data = a.data ? {model: a.data} : {})),
            ...
            route: function(t, n, r) {
                ...
                return (
                    e.history.route(t, function(i) {
                        ...
                        !1 !== s.execute(r, a, n) &&
                            (s.trigger.apply(s, ['route:' + n].concat(a)), s.trigger('route', n, a), e.history.trigger('route', s, n, a));
                    }),
                    this
                );
            },
        ...
        (e.version = '2.3.6'),
            ...
            (e.Pipeline.warnIfFunctionNotRegistered = function(t) {
                (t.label && t.label in this.registeredFunctions) ||
                    e.utils.warn('Function is not registered with pipeline. This may cause problems when serialising the index.\n', t);
            }),
            ...
            (e.Vector.prototype.dot = function(e) {
                for (var t = 0, r = this.elements, i = e.elements, n = r.length, s = i.length, o = 0, a = 0, u = 0, l = 0; u < n && l < s; )
                    (o = r[u]) < (a = i[l]) ? (u += 2) : a < o ? (l += 2) : o == a && ((t += r[u + 1] * i[l + 1]), (u += 2), (l += 2));
                return t;
            }),
                        ...
                        if (
                            ...
                            (i = (I = a.exec(r))[1]),
                                (a = f).test(i) &&
                                    ((u = w),
                                    (l = Q),
                                    (a = x).test((r = i)) ? (r += 'e') : u.test(r) ? ((o = g), (r = r.replace(o, ''))) : l.test(r) && (r += 'e'));
                        }
                ...
                for (var i = new e.TokenSet(), n = [{node: i, editsRemaining: r, str: t}]; n.length; ) {
                    ...
                    if (0 != s.editsRemaining) {
                        ...
                        if (
                            ...
                            1 < s.str.length && n.push({node: s.node, editsRemaining: s.editsRemaining - 1, str: s.str.slice(1)}),
                        ...
                        for (var g = 0; g < y.length; g++) {
                            ...
                            for (m = 0; m < l.fields.length; m++) {
                                var k = w[(v = l.fields[m])],
                                    ...
                                    L = new e.Set(S);
                                if (
                                    (l.presence == e.Query.presence.REQUIRED && ((h = h.union(L)), void 0 === o[v] && (o[v] = e.Set.complete)),
            ...
            (e.Index.prototype.toJSON = function() {
                ...
                return {version: e.version, fields: this.fields, fieldVectors: r, invertedIndex: t, pipeline: this.pipeline.toJSON()};
            }),
                        ...
                        (c.namespace != namespace && '*' != c.namespace) ||
                            $context.find(c.selector).each(function(m, el) {
                                ...
                                (instance = $el.data('component'))
                                    ...
                                    : ((instance = new c.constructor({el: el})), $el.data('component', instance), result.push(instance));
                            });
                    }),
                    result
                );
        ...
        var Viewport = (function(_super) {
            ...
            return (
                ...
                (Viewport.prototype.onScroll = function() {
                    (this.scrollTop = typedoc.$window.scrollTop() || 0), this.trigger('scroll', this.scrollTop);
                }),
                Viewport
            );
        })(typedoc.Events);
            ...
            return (
                ...
                (MenuSticky.prototype.onResize = function(width, height) {
                    ...
                    var containerTop = this.$container.offset().top,
                        containerHeight = this.$container.height() || 0,
    ...
    (function(typedoc) {
        ...
        !(function(search) {
            ...
            function createIndex() {
                ...
                builder.pipeline.add(lunr.trimmer), builder.field('name', {boost: 10}), builder.field('parent'), builder.ref('id');
