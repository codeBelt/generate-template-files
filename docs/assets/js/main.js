    ...
    (n.fn = n.prototype = {
        ...
        n.extend({
            ...
            isPlainObject: function(a) {
                return (
                    'object' === n.type(a) && !a.nodeType && !n.isWindow(a) && !(a.constructor && !j.call(a.constructor.prototype, 'isPrototypeOf'))
                );
            },
            ...
            return this instanceof n.Event
                ? (a && a.type
                      ? ((this.originalEvent = a),
                        (this.type = a.type),
                        (this.isDefaultPrevented = a.defaultPrevented || (void 0 === a.defaultPrevented && !1 === a.returnValue) ? Z : $))
                      : (this.type = a),
                  b && n.extend(this, b),
            ...
            attr: function(a, b, c) {
                ...
                if (a && 3 !== f && 8 !== f && 2 !== f)
                    return typeof a.getAttribute === U
                        ? n.prop(a, b, c)
                        : ((1 === f && n.isXMLDoc(a)) || ((b = b.toLowerCase()), (d = n.attrHooks[b] || (n.expr.match.bool.test(b) ? Zb : void 0))),
                          void 0 === c
            ...
            ajax: function(a, b) {
                ...
                (i = k.global),
                    ...
                    k.hasContent ||
                        ...
                        !1 === k.cache && (k.url = hc.test(d) ? d.replace(hc, '$1_=' + cc++) : d + (dc.test(d) ? '&' : '?') + '_=' + cc++)),
                    k.ifModified &&
        ...
        i.extend(w.prototype, u, {
            ...
            (e.sync = function(t, r, s) {
                ...
                if (
                    ...
                    s.emulateJSON && ((a.contentType = 'application/x-www-form-urlencoded'), (a.data = a.data ? {model: a.data} : {})),
        ...
        (t.version = '0.5.3'),
            ...
            (t.Pipeline.warnIfFunctionNotRegistered = function(e) {
                (e.label && e.label in this.registeredFunctions) ||
                    t.utils.warn('Function is not registered with pipeline. This may cause problems when serialising the index.\n', e);
            }),
...
!(function(typedoc) {
    ...
    !(function(search) {
        function createIndex() {
            function batch() {
                for (var cycles = 0; cycles++ < 100; ) if ((index.add(rows[pos]), ++pos == length)) return setLoadingState(SearchLoadingState.Ready);
                setTimeout(batch, 10);
            }
...
!(function(typedoc) {
    ...
    (typedoc.transition = (function(tuples) {
        for (var name in tuples) if (tuples.hasOwnProperty(name) && void 0 !== document.body.style[name]) return {name: name, endEvent: tuples[name]};
        return null;
    })({
