...
describe('__store__Effects', () => {
    ...
    describe('fetch__model__', () => {
        it('returns a response model and called with the correct request data', async () => {
            ...
            const actualResult = await __store__Effects.fetch__model__() as __model__ResponseModel;
        ...
        it('returns a error model', async () => {
            ...
            const actualResult = await __store__Effects.fetch__model__() as HttpErrorResponseModel;
